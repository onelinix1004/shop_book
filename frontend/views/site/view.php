            ...
            <div class="single-product cold-md-12">
                <div class="col-md-6">
                    ...
                    <img  src="<?= $product->image ?>" alt="img"
                         style="width: 270px;height: 320px; margin-left: 30px;">
                </div>
                <div class="product-details col-md-6">
                    ...
                    <form action="index.php?r=cart/add-cart&id=<?= $product->id ?>" method="POST"
                        ...
                        <input type="number" name="quantity" value="1" class="qty" min="1" max="100"
                               style="font-size: 15px; font-weight: bold; flex-grow: 1; margin-right: 5px; margin-left: -110px;">
                        <input type="submit" value="THÊM VÀO GIỎ HÀNG" class="btn btn-warning"
                               style="font-size: 15px; font-weight: bold;background-color:#5a423b!important;">
                    </form>
                    <a href="<?= Yii::$app->urlManager->createUrl(
                        ['site/flipbook', 'id' => $product->id]) ?>" class="btn btn-warning"
                       style="padding-top: 5px; margin-top: 20px; font-size: 18px; font-weight: bold; color: #FFFFFF; background-color: #5a423b!important; width: 181px;height: 35px; margin-left: 90px;">
                            ...
                            <div class="tab-pane fade" id="review" role="tabpanel" aria-labelledby="review-tab">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="col-6">
                                            <div class="box_total"
                                                 style="display: flex; border-bottom: 1px solid black; border-opacity: 0.5; width: 100%;">
                                                <div class="box_1" style="flex-grow: 1/3; width: 50%;">
                                                    <h5 style="text-align: center; font-size: 20px; margin-left: 320px; font-weight: 800;">
                                                        OVERALL</h5>
                                                    ...
                                                    <div class="start" style="margin-right: -463px;">
                                                        <?php if (is_numeric($averageRating)): ?>
                                                            ...
                                                            <span class="fa fa-star-o"
                                                                  style="font-size: 24px; color: gold; margin: 15px 0.5rem 0 0.5rem; transform: translate(-50%, -50%);"></span>
                                                ...
                                                <div class="box_2">
                                                    <button id="add-review-btn" class="btn btn-primary"
                                                            style="margin-top: 100px; margin-bottom: 20px; margin-right: 1500px;">
                                        ...
                                        <div>
                                            ...
                                            <div class="rating">
                                                <span class="fa fa-star-o " id="star1"
                                                      style="font-size: 24px; color: gray;"></span>
                                                <span class="fa fa-star-o" id="star2"
                                                      style="font-size: 24px; color: gray;"></span>
                                                <span class="fa fa-star-o" id="star3"
                                                      style="font-size: 24px; color: gray;"></span>
                                                <span class="fa fa-star-o" id="star4"
                                                      style="font-size: 24px; color: gray;"></span>
                                                <span class="fa fa-star-o" id="star5"
                                                      style="font-size: 24px; color: gray;"></span>
                                            </div>
                                        ...
                                        <div class="review_list">
                                            <?php foreach ($reviews as $review): ?>
                                                <div class="review"
                                                     style="display: flex; border-opacity: 0.5; width: 100%;">
